...
namespace WindowsFormsApp1
{
    public partial class FrmÖğretmenDetay : Form
    {
        ...
        {
            Bağlanti.Open();
            SqlCommand komut = new SqlCommand("insert into TBLDERS (OGRNUMARA,OGRAD,OGRSOYAD) values (@P1,@P2,@P3)" ,Bağlanti);
        ...
        Bağlanti.Open();
            SqlCommand komut = new SqlCommand("update TBLDERS set OGRS1=@P1,OGRS2=@P2,OGRS3=@P3,ORTALAMA=@P4,DURUM=@P5 WHERE OGRNUMARA=@P6", Bağlanti);
